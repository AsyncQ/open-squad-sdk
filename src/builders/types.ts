...
import type { SquadProviderConfig } from '../adapter/types.js';
export type { SquadProviderConfig };
...
export interface SquadSDKConfig {
  ...
  /** Custom model provider (BYOK). Redirects model inference to a custom endpoint. */
  readonly provider?: SquadProviderConfig;
}
