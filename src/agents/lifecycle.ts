...
import type { SquadSession, SquadSessionConfig, SquadProviderConfig } from '../adapter/types.js';
...
export interface LifecycleManagerConfig {
  ...
  /** Custom model provider (BYOK). When set, all sessions use this endpoint instead of Copilot's. */
...
export class AgentLifecycleManager {
  ...
  private provider: SquadProviderConfig | undefined;
